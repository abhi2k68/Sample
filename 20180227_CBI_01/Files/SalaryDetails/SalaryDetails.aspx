...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function CalculateOtherIncome() {
            ...
            var tempValue = Return(tta.value) + Return(salaryFrmPrevEmp.value) + Return(incomeFromHouseProp.value) + Return(incomeFromBsnAndProf.value) + Return(capitalGains.value) + Return(incomeFrmOtherSources.value);
            ...
            if (creditUS87A != null) {
                ...
                if (IsInvalidPAN.value == 1) {
                    ...
                    if (Return(totTaxableIncome.value) > 200000 && Return(totTaxableIncome.value) <= 500000) {
                         if (FinYear.value < 2016) {
                            creditUS87A.value = 2000;
                        }
                        else if (FinYear.value >= 2016 && FinYear.value < 2017) {
                            creditUS87A.value = 5000;
                        }
                        else if (FinYear.value >= 2017 && Return(totTaxableIncome.value) <= 350000) {
                ...
                if (finYear >= 2014 && taxRate == 0) {
                    if (IsSeniorCitizen == 0)
                        ...
                        if ((taxOnTotalIncome / taxableIncome) * 100 < 20) {
                            ...
                            taxOnTotalIncome = (taxableIncome - 250000) * 0.2;
                        }
                    }
                    if (IsSeniorCitizen == 1)
                        ...
                        if ((taxOnTotalIncome / taxableIncome) * 100 < 20) {
                            eduCess = ""; rate1 = 0;
                            document.getElementById("<%=txtCreditUS87A.ClientID%>").value = "";
                            taxOnTotalIncome = (taxableIncome - 300000) * .2;
                        }
                    }
                    if (IsSeniorCitizen == 2)
                        ...
                        if ((taxOnTotalIncome / taxableIncome) * 100 < 20) {
                            eduCess = ""; rate1 = 0;
                            document.getElementById("<%=txtCreditUS87A.ClientID%>").value = "";
                            taxOnTotalIncome = (taxableIncome - 500000) * .2;
                        }
                    }
                }
                else {
        ...
        function CalculateTaxAmounts() {
            ...
            if (document.getElementById("<%=txtCreditUS87A.ClientID%>") != null && document.getElementById("<%=hdnIsInValidPAN.ClientID%>").value == 0) {
                ...
                if (Return(document.getElementById("<%=txtTotalTaxableIncome.ClientID%>").value) > 200000 && Return(document.getElementById("<%=txtTotalTaxableIncome.ClientID%>").value) <= 500000) {
                   ...
                   else if (document.getElementById("<%=hdnFinYear.ClientID%>").value >= 2016 && document.getElementById("<%=hdnFinYear.ClientID%>").value < 2017) {
                        document.getElementById("<%=txtCreditUS87A.ClientID%>").value = 5000;
                    }
                    else if (document.getElementById("<%=hdnFinYear.ClientID%>").value >= 2017 && Return(document.getElementById("<%=txtTotalTaxableIncome.ClientID%>").value) <= 350000) {
            ...
            document.getElementById("<%=txtTotalITPayable.ClientID%>").value = (Return(document.getElementById("<%=txtTaxOnTotalIncome.ClientID%>").value) - Return(creditUS87A)) + Return(document.getElementById("<%=txtEduCess.ClientID%>").value);
        ...
        function ValidateTotalDeductibleAmnt() {
            if (ValidateTotalDeductibleAmount(document.getElementById("<%=cmbSection.ClientID%>"), document.getElementById("<%=rbnValue2.ClientID%>"), document.getElementById("<%=rbnValue3.ClientID%>"),
                                              document.getElementById("<%=txtGrossAmount.ClientID%>"), document.getElementById("<%=txtQualifyingAmount.ClientID%>"), document.getElementById("<%=txtDeductibleAmount.ClientID %>"))) {
                SetValues();
            }
            else {
                return false;
        ...
        function SetLimitValues() {
            ...
            switch (document.getElementById("<%=cmbSection.ClientID%>").value) {
                ...
                case "14":
                    ...
                    break;
                case "8": minVal = "40000"; maxVal = (Number(finYear) >= 2016) ? "80000" : "0";
                    if (document.getElementById("<%=rbnValue1.ClientID%>").checked) {
        ...
        function SetQualifyingAmount() {
            ...
            switch (sectionID) {
                ...
                case "80TTA": qualifyingAmt = 10000; break;
                case "80U":
                    maxVal = ((Number(finYear) > 2014) ? 125000 : 100000);
                    minVal = ((Number(finYear) > 2014) ? 75000 : 50000);
                    if ((!rbtnValue1.checked && !rbtnValue2.checked) || rbtnValue1.checked)
                                        ...
                                        <td class="eCol" width="770px" valign="top">
                                            <table style="height: 331px; width: 100%">
                                                            ...
                                                            <tr>
                                                                <td style="padding-left: 1px">
                                                                    ...
                                                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderName" runat="server" MinimumPrefixLength="2"
                                                                        ...
                                                                        TargetControlID="txtName" CompletionInterval="1" EnableCaching="false" CompletionSetCount="20"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="aligntd">
                                                        <asp:TextBox ID="txtET" runat="server" MaxLength="14" AutoComplete="off" TabIndex="5"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="aligntd">
                                                        <asp:TextBox ID="txtPT" runat="server" AutoComplete="off" TabIndex="6" MaxLength="14"
                                                            CssClass="txtAR" onkeypress="return numeralsOnly(this, event,10,0,0,1);" onchange="return checkDecimalNo(this);"
                                                            onkeyup="CalculateValues();">                                                
                                                        </asp:TextBox>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Button ID="btnOtherIncomeDetails" Text="..." runat="server" CssClass="popBtn"
                                                                        OnClientClick="return AlertUser();" OnClick="btnOtherIncomeDetails_Click" TabIndex="7" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                        ...
                                        <td class="eCol" width="770px" valign="top">
                                            <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Button ID="btnDeductionUc" Text="..." runat="server" CssClass="popBtn" OnClientClick="return AlertUser();"
                                                                        OnClick="btnDeductionUc_Click" TabIndex="8" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="aligntd">
                                                        <asp:TextBox ID="txtTaxOnTotalIncome" runat="server" AutoComplete="off" TabIndex="9"
                                                            MaxLength="14" CssClass="txtAR" onkeypress="return numeralsOnly(this, event,10,0,0,1);"
                                                ...
                                                <tr id="rowCreditUS87A" runat="server">
                                                    ...
                                                    <td class="aligntd">
                                                        <asp:TextBox ID="txtCreditUS87A" runat="server" AutoComplete="off" TabIndex="9" MaxLength="14"
                                                            Enabled="false" CssClass="txtAR"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="vHCol">
                                                    ...
                                                    <td class="aligntd">
                                                        <asp:TextBox ID="txtSurcharge" runat="server" MaxLength="14" CssClass="txtAR" Enabled="false"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="aligntd">
                                                        <asp:TextBox ID="txtEduCess" runat="server" AutoComplete="off" TabIndex="10" MaxLength="14"
                                                            CssClass="txtAR" onkeypress="return numeralsOnly(this, event,10,0,0,1);" onchange="return checkDecimalNo(this);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="aligntd">
                                                        <asp:TextBox ID="txtReliefUnderSection89" runat="server" AutoComplete="off" TabIndex="11"
                                                            MaxLength="14" CssClass="txtAR" onkeypress="return numeralsOnly(this, event,10,0,0,1);"
                                                            onchange="return checkDecimalNo(this);" onkeyup="CalculateTaxAmounts();">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Button ID="btnTDSMadeDetails" Text="..." runat="server" CssClass="popBtn" OnClientClick="return AlertUser();"
                                                                        OnClick="btnTDSMadeDetails_Click" TabIndex="12" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderPANLL1" runat="server" MinimumPrefixLength="1"
                                        ...
                                        TargetControlID="txtPANLL1" CompletionInterval="2" EnableCaching="false" CompletionSetCount="20"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderPANLL2" runat="server" MinimumPrefixLength="1"
                                        ServicePath="~/WebServices/AutoCompleteService.asmx" ServiceMethod="LandlordPAN"
                                        TargetControlID="txtPANLL2" CompletionInterval="2" EnableCaching="false" CompletionSetCount="20"
                                        DelimiterCharacters="" ShowOnlyCurrentWordInCompletionListItem="true" FirstRowSelected="false">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderPANLL4" runat="server" MinimumPrefixLength="1"
                                        ServicePath="~/WebServices/AutoCompleteService.asmx" ServiceMethod="LandlordPAN"
                                        TargetControlID="txtPANLL4" CompletionInterval="2" EnableCaching="false" CompletionSetCount="20"
                                        DelimiterCharacters="" ShowOnlyCurrentWordInCompletionListItem="true" FirstRowSelected="false">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderPANL1" runat="server" MinimumPrefixLength="1"
                                        ServicePath="~/WebServices/AutoCompleteService.asmx" ServiceMethod="LandlordPAN"
                                        TargetControlID="txtPANL1" CompletionInterval="2" EnableCaching="false" CompletionSetCount="20"
                                        DelimiterCharacters="" ShowOnlyCurrentWordInCompletionListItem="true" FirstRowSelected="false">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderPANL2" runat="server" MinimumPrefixLength="1"
                                        ServicePath="~/WebServices/AutoCompleteService.asmx" ServiceMethod="LandlordPAN"
                                        TargetControlID="txtPANL2" CompletionInterval="2" EnableCaching="false" CompletionSetCount="20"
                                        DelimiterCharacters="" ShowOnlyCurrentWordInCompletionListItem="true" FirstRowSelected="false">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderPANL3" runat="server" MinimumPrefixLength="1"
                                        ServicePath="~/WebServices/AutoCompleteService.asmx" ServiceMethod="LandlordPAN"
                                        TargetControlID="txtPANL3" CompletionInterval="2" EnableCaching="false" CompletionSetCount="20"
                                        DelimiterCharacters="" ShowOnlyCurrentWordInCompletionListItem="true" FirstRowSelected="false">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtenderPANL4" runat="server" MinimumPrefixLength="1"
                                        ServicePath="~/WebServices/AutoCompleteService.asmx" ServiceMethod="LandlordPAN"
                                        TargetControlID="txtPANL4" CompletionInterval="2" EnableCaching="false" CompletionSetCount="20"
                                        DelimiterCharacters="" ShowOnlyCurrentWordInCompletionListItem="true" FirstRowSelected="false">
                                    </cc1:AutoCompleteExtender>
                                </td>
                                <td>
